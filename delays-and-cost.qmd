...
The cost of ATFM delay in this report is based on the [**European airline delay cost reference values,**]{.underline} published by the University of Westminster[^4]. In each new ACE report, the PRU expresses the cost of one minute of ATFM delay in the price base of the year under review, using the average European Union inflation rate published by EUROSTAT.
