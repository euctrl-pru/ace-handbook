...
![Framework for economic cost-effectiveness performance analysis](./images/image4.png){#fig-framework-economic width="4.461975065616798in" height="3.319673009623797in"}
...
The cost of ATFM delay in this report is based on the [**European airline delay cost reference values,**]{.underline} published by the University of Westminster [@uow:costofdelay], see[^4]. In each new ACE report, the PRU expresses the cost of one minute of ATFM delay in the price base of the year under review, using the average European Union inflation rate published by EUROSTAT.

[^4]: European airline delay cost reference values (December 2015), available at: <http://www.eurocontrol.int/publications/european-airline-delay-cost-reference-values>.
