...
The framework illustrated in @fig-factors-cost shows **exogenous** (outside the control of ANSPs) and **endogenous** (under ANSPs' control) factors which influence ANSP performance.

![Factors affecting cost-effectiveness performance](./images/image5.png){#fig-factors-cost width="80%"}
...
![Legal & socio-economic conditions](./images/image6.png){#fig-legal-socio width="60%" fig-pos="H"}
...
![Operational conditions](./images/image7.png){#fig-operational-conditions width="60%" fig-pos="H"}
...
![Institutional & governance arrangements](./images/image8.png){#fig-institutional-arrangements width="60%" fig-pos="H"}
...
@fig-org-factors lists the factors that would need to be considered in the scope of a comprehensive analysis of the impact of **ANSP organisation** on performance. They mainly relate to four issues which are typically addressed in the Balanced Scorecard methodology.

![Organisational factors](./images/image9.png){#fig-org-factors width="55%" fig-pos="H"}
...
![Managerial & financial aspects](./images/image10.png){#fig-managerial width="55%" fig-pos="H"}
...
@fig-operational-setup provides a list of factors that would need to be considered in a comprehensive examination of the influence of **ANSP operational and technical setup** on performance. They mainly relate to the following three issues:

-   Operational structure;
-   Operational concepts and processes; and
-   Operational flexibility.

![Operational & technical setup](./images/image11.png){#fig-operational-setup width="60%" fig-pos="bht"}
