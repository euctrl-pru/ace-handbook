...
@fig-operationalsetup provides a list of factors that would need to be considered in a comprehensive examination of the influence of **ANSP operational and technical setup** on performance. They mainly relate to the following three issues: 

- Operational structure;
- Operational concepts and processes; and
- Operational flexibility. 

![Operational & technical setup](./images/image11.png){#fig-operationalsetup width="2.973611111111111in" height="2.061111111111111in"} |
